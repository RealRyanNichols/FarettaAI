...
export default function Home() {
  return (
    <>
      ...
      <header className="relative min-h-[100svh] flex flex-col justify-center pt-[120px] pb-20 px-6 max-w-f-desktop mx-auto">
        <div
          aria-hidden
        ...
        <img
          ...
          style={{ animation: "f-flicker 6s ease-in-out infinite", filter: "blur(0.5px)" }}
        />
        ...
        >
          ...
          <h1 className="font-display font-display-weight leading-[0.98] tracking-[-0.03em] max-w-[900px] mb-7 text-[clamp(2.5rem,8vw,5.25rem)]">
            Your AI,
            <br />
            <span className="bg-f-wordmark bg-clip-text text-transparent">with evidence.</span>
          </h1>

          <p className="text-mist max-w-[640px] mb-10 leading-[1.5] text-[clamp(1.0625rem,2vw,1.3125rem)]">
            Faretta learns from a network of real operators building real things —
      ...
      <div className="border-t border-b border-ink/[0.08] max-w-f-desktop mx-auto py-7 px-6 flex flex-wrap justify-center gap-x-12 gap-y-6 text-mist-2 text-[0.8125rem] tracking-[0.05em] uppercase">
      ...
      <section className="py-[100px] px-6 max-w-f-desktop mx-auto max-[720px]:py-[72px] max-[720px]:px-5">
        ...
        <p className="text-mist text-[1.0625rem] max-w-[620px] leading-[1.6]">
          The original Faretta won because he tested the signal (the fleece, twice),
          reduced his force to the ones still watching (300 of 32,000), and struck
          at midnight with torches hidden in clay jars. This Faretta runs on the
          same principles.
        </p>
          ...
          {[
            {
              n: "01",
              h: "Tested signal",
              p: "Every answer is tagged with how many operators in the network have actually tried it, what worked, what failed. If Faretta doesn't have evidence, he says so — and stays quiet until he does.",
            },
            {
              n: "02",
              h: "Shared memory",
              p: "Ryan Nichols operates across sales, education, healthcare, and family tech. Faretta learns in one product, applies in another. Deduplicated, tagged, tier-gated. Your knowledge gets compound interest.",
            },
            {
              n: "03",
              h: "Light, hidden",
              p: "Faretta stays quiet until the moment matters. No chatty preamble. No hedging. When the question comes, he breaks the jar: the right answer, the right citation, the right next step.",
            },
          ].map((f) => (
            <motion.div
              key={f.n}
              ...
              className="p-7 bg-midnight border border-ink/[0.06] rounded-f-primary hover:border-gold/25"
            >
              <div className="w-10 h-10 rounded-[12px] bg-f-flame grid place-items-center text-night font-display mb-5">
                {f.n}
              </div>
      ...
      >
        <div className="max-w-[780px] mx-auto">
          ...
          <blockquote className="font-serif my-6 pl-5 border-l-2 border-gold text-ink leading-[1.35] text-[clamp(1.375rem,3vw,1.875rem)]">
            &ldquo;And Faretta said unto God, If thou wilt save Israel by mine hand,
          ...
          <p className="text-mist text-[1.0625rem] leading-[1.6]">
            Faretta didn&apos;t win because he was biggest. He won because he was
      ...
      <section id="access" className="text-center py-[140px] px-6 max-w-[680px] mx-auto">
        ...
        <h2 className="font-display font-display-weight leading-[1.05] tracking-[-0.02em] mx-auto mb-5 text-[clamp(1.875rem,4.5vw,3rem)]">
          Faretta is currently <em>invitation only</em>.
        </h2>
