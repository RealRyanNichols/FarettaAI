  ...
  return (
    <>
      ...
      <main className="relative pt-[140px] pb-20 px-6 max-w-[760px] mx-auto">
        ...
        {state.status === "ok" ? (
          <div className="rounded-g-primary border border-gold/40 bg-[linear-gradient(180deg,rgba(212,168,85,0.08),rgba(255,107,44,0.04))] p-8">
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4 max-[560px]:grid-cols-1">
              <label className="block">
                ...
                <input
                  ...
                  name="name"
                  maxLength={120}
                  className="w-full px-4 py-3 rounded-g-secondary bg-[rgba(18,22,35,0.6)] border border-ink/10 text-ink text-[0.9375rem] outline-none focus:border-gold transition-colors"
            ...
            <label className="block">
              ...
              <textarea
                ...
                maxLength={4000}
                rows={6}
                className="w-full px-4 py-3 rounded-g-secondary bg-[rgba(18,22,35,0.6)] border border-ink/10 text-ink text-[0.9375rem] outline-none focus:border-gold transition-colors resize-y"
                placeholder="Tell us what situation you are in, what you want Gideon to help with, or what you need from Ryan."
              />
            </label>
