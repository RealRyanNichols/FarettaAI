...
|------|------|----------|-------------|
| `tab` | `string` | yes | One of Home, Mommy, Faretta, Calendar, Bible, Income, Booking, Academy, Meals, Organize, Leads, Social, Life, Habits, Vault, BabyYear, Store, Settings. |
...
groceries?") and the answer maps to a single Nest tab, Faretta replies
