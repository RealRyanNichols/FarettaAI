# 2026-04-20 — Ryan's founding brief for Faretta
...
> "I like Faretta. Now is there a cool thing that we could do with
> Faretta? Is there a cool name that we could do with it? Like,
...
> Faretta six, that'll do — Gemini is six, ChatGPT is seven, so
> Faretta would be fine."

## Portfolio Faretta will serve
...
- **Name**: Faretta (final — see `LEARNED/2026-04-20-naming.md`).
- **Folder**: `Faretta-AI/` (this folder). Canonical source for all
  Ryan's repos.
...
3. When does Faretta get his own dedicated domain + marketing site?
