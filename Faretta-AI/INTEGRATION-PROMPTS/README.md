...
- The product slug — every `setProject()`, every `<FarettaChat project="...">`,
...
the `Faretta-AI/` tree. Any prompt edit is a LEARNED-worthy change:
