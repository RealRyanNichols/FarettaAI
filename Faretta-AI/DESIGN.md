...
- **Text gradient (hero word "FARETTA"):** `linear-gradient(135deg, #D4A855 0%, #F4EFE4 50%, #D4A855 100%)` — bronze washed with parchment.
...
when Faretta quotes something weighty; the product chrome is sans.
...
`FARETTA` in all caps, Inter 700, letter-spacing `0.12em`, `--g-gold`
...
- Biblical: **"The sword of the LORD, and of Faretta."** (brand moments
...
- **No bounce on loops.** Faretta doesn't bounce. He flickers like flame.
